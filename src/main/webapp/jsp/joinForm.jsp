...
function joinValidation() {
	...
	let confirmPassword = joinForm.confirmPassword.value
	...
	/* 주민번호 : 숫자만 주민번호 유효성
		 ...
		 (가입 신청클릭시) */
	let regExJcode = /^[0-9]*$/	
	let jcode1 = joinForm.jcode1.value
	let jcode2 = joinForm.jcode2.value
...
<body>
	<form name="joinForm" onsubmit="return joinValidation()" method="post">
		<table width="1400">
			<tr>
			...
			<tr>
				...
				<hr>
					<p align="left" style="padding-left:160px">					
					  id : <input type="text" name="id" /> <input type="button" value="중복체크"/></br></br>
					    ...
					    이름 : <input type="text" name="name" onkeyup="checkName(5)"/></br></br>
